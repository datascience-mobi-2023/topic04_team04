...
ggplot2::ggplot() +
  geom_sf(data = district_sf, aes(fill = incidence)) +
  scale_fill_gradientn(colors = rev(terrain.colors(100))) + labs(fill = "Incidence") + labs(title = "Average incidences for monsoon 2012")
...
ggplot2::ggplot() +
  ...
  scale_fill_gradientn(colors = rev(terrain.colors(100))) + labs(fill = "Temperature") + labs(title = "Average temperature for monsoon 2012")
