...
## Loading the dengue-excel-sheets and transforming them into data frames
...
#combinign the single years into one data frame
...
sorting the data frame by province names transforming the data frame, to move the time scale from the x-axis to the y-axis
...
detecting all NA and removing the rows containing them
...
## structure data frame and convert into right datatypes
...
# adding the data from Bunkan-district to Nong Khai and deleting all Bunkang-Data
...
#creating a data-frame for mapping by setting values of Bungkan equal to Nong Khai 
