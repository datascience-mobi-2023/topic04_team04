...
temp_data = read_excel("Excel-data/era5_data_2006_2020_thailand_monmean.xlsx")
...
for (i in 2006:2011) {
  ...
  Dateiname = paste0(i, Endung) # creating the file name
  Pathway1 = paste0("Excel-Data/", Dateiname)
  population_df = read_excel(Pathway1) # creating the variable and assigning the excel-sheet
...
population_df = read_excel("Excel-Data/2012-2020_population.xlsx")
