...
plot(my.p1.mask, legend.width=1, legend.shrink=0.75, axes= FALSE, box=FALSE) + title("Predicted values: Influence of Temp on dengue cases for 2021-2040", line = +1) + plot(thailand, add=TRUE)
detach(data_total)
```
