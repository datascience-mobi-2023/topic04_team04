...
D_inc_temp = dist(apply(m_inc_temp.y.r[,c("incidence","temperature")],2, rank))
km_inc_temp = kmeans(apply(m_inc_temp.y.r[,c("incidence","temperature")],2, rank), centers = 3)
s_inc_temp = silhouette(km_inc_temp$cluster,D_inc_temp)
plot(s_inc_temp)
fviz_nbclust(apply(m_inc_temp.y.r[,c("incidence","temperature")],2, rank), pam, method = "silhouette")+ theme_classic()

m_inc_temp_cluster.y.r = data.frame(m_inc_temp.y.r, km_inc_temp$cluster)


ggplot(m_inc_temp_cluster.y.r, aes(x = temperature, y = incidence, color = as.factor(km_inc$cluster))) +
  geom_point() +
  labs(title = "Partitioning Clustering Plot") +
  theme_classic()

ggplot(m_inc_temp_cluster.y.r, aes(x = temperature, y = incidence, color = as.factor(km_inc_temp$cluster))) +
  geom_point() +
  labs(title = "Partitioning Clustering Plot") +
  theme_classic()
```
