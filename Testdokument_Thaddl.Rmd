...
p = p + geom_line(data = mean_temp, aes(x = time_column, y = temperature), color = "red") + 
  scale_y_continuous(sec.axis = sec_axis(~ rescale(., to = range(mean_temp$temperature)), name = "Temperature"))
print(p)
```
