...
plot(data_total$temperature, data_total$incidence, pch = 20,
     ylab = "incidence",
     xlab = "temperature",
  abline(v = mean(data_total$temperature), col = "red"), lines(data_total$temperature, d1, col = "red")
  )
...
plot(my.p1.mask, legend.width=1, legend.shrink=0.75, axes= FALSE, box=FALSE) + title("Predicted values: Influence of max Temp on Abun2", line = -1) + plot(gambia, add=TRUE)
```
